 ...
 *
 * <p>The chain (bytecode-verified on 26.2; re-verified on 1.21.10 at the v0.14 port): the server writes
...
public interface AccessorBiomeManager {
    ...
    /** {@code private final long biomeZoomSeed} — javap-verified present on 26.2 and 1.21.10, and

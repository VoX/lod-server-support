// OVERLAY OF xplat/src/main/java/dev/vox/lss/compat/VoxyCompat.java @ e9922707fe59cd8099cd980f7046bb9d008df6412d5c2c5ee057c31de55d3aa5
...
class VoxyCompat {
    ...
    static ModCompat.VoxyResetReport resetVoxyProduction(boolean forceWipe,
        ...
        return resetVoxy(productionHandleHooks(gameDir,
                ...
                () -> {
                    // 1.21.11 line flavor: the render-extract rework is 26.2-only —
                    // the rebuild call is the classic LevelRenderer.allChanged().

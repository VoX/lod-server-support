...
public class LSSGameTests {
    ...
    public void allConfigFieldsInValidRange(GameTestHelper helper) {
        ...
        helper.assertTrue(c.maxWaitingGenerations >= 1 && c.maxWaitingGenerations <= 1024, "maxWaitingGenerations");
        helper.assertTrue(c.maxWaitingGenerationsPerPlayer >= 1 && c.maxWaitingGenerationsPerPlayer <= 256, "maxWaitingGenerationsPerPlayer");

...
public abstract class DecodeWireMixin {
    ...
    @Redirect(method={"drainColumnQueue(Lnet/minecraft/class_5321;IIZLnet/minecraft/class_2378;Ljava/util/function/UnaryOperator;Ldev/vox/lss/networking/client/ClientColumnProcessor$ColumnDispatcher;I)V","drainColumnQueue(Lnet/minecraft/resources/ResourceKey;IIZLnet/minecraft/core/Registry;Ljava/util/function/UnaryOperator;Ldev/vox/lss/networking/client/ClientColumnProcessor$ColumnDispatcher;I)V"},at=@At(value="INVOKE",target="Ldev/vox/lss/networking/client/ClientColumnProcessor$QueuedColumn;payload()Ldev/vox/lss/networking/payloads/VoxelColumnS2CPayload;"),require=1,expect=1,allow=1)
    private VoxelColumnS2CPayload lssRigExactPayload(@Coerce Object queued){
        try{
            ...
            SmokeClient.decoding(payload);return payload;
        }catch(ReflectiveOperationException error){throw new IllegalStateException("exact native wire association failed",error);}
    }
    @Inject(method={"drainColumnQueue(Lnet/minecraft/class_5321;IIZLnet/minecraft/class_2378;Ljava/util/function/UnaryOperator;Ldev/vox/lss/networking/client/ClientColumnProcessor$ColumnDispatcher;I)V","drainColumnQueue(Lnet/minecraft/resources/ResourceKey;IIZLnet/minecraft/core/Registry;Ljava/util/function/UnaryOperator;Ldev/vox/lss/networking/client/ClientColumnProcessor$ColumnDispatcher;I)V"},at=@At("RETURN"),require=1,expect=1,allow=1)
    private void lssRigClearDecode(CallbackInfo ci){SmokeClient.decodingFinished();}
}

...
## Scoped commits and parity

- 26.2: `98b67abc82283417ad288cbb0cca2f4fb3343425` (43 explicitly staged paths).
- 26.1: `1e7c9a9d3507c3ba90ac511ba6b62995b8796ab2` (43 explicitly staged paths).
- 1.21.11: `8ac799a901e7eb99cb9403d512b790a0b6576190` (43 explicitly staged paths).
- 1.21.10: `948b0bf09dd852d357176577d7ccacd589aadb7d` (14 explicitly staged paths).
- 1.21.1: `49c8c689fb3a21970fa0110597c0bee8574c3018` (10 explicitly staged paths).

Fabric executor bytes match across all five lines; Paper executors differ only in package declaration and match their Fabric twins. MC dimension identifier spellings in existing drivers remain per-line. 1.21.10 uses the existing Gt assertion seam; other annotation/API flavors are preserved. No common/xplat/production delivery or shipped client code changed.

Executor SHA-256 (Fabric source): `1fe2c013069f2c3193a06926b681370c84031cb5cef628075be05830d3841917`.

Independent read-only review by audit04_client checked routing, callback timing, generic cleanup, per-world query prefixes, historical false-green rejection, and test fidelity. Actual Paper/Folia per-world readback remains the next live acceptance check; the corrected soak was not launched by this subagent. Gradle slot was handed back after all focused processes exited.
